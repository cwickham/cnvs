...
test_that("all forms of specifying endpoint are equivalent", {
  ...
  expect_equal(gh_build_request("/courses", api_url = "https://canvas.instructure.com/api/v1"), r1)
  expect_equal(gh_build_request("GET https://canvas.instructure.com/api/v1/courses"), r1)
  expect_equal(gh_build_request("https://canvas.instructure.com/api/v1/courses"), r1)
})

test_that("method arg sets default method", {
  r <- gh_build_request("/courses", method = "POST")
